...
![sina_2gram.png](./assets/sina_2gram.png)
...
- 训练完成后，模型文件会存储在 `res` 目录下，下一次预测会直接加载模型，避免重复训练
...
| 模型 | 字准确率  | 句准确率  | 训练时长  | 预测时长 |
| :--: | :-------: | :-------: | :-------: | :------: |
| 二元 | $84.04\%$ | $39.72\%$ | $132.76s$ | $3.23s$  |
| 三元 | $92.53\%$ | $69.06\%$ | $351.82s$ | $16.85s$ |

![sina_3gram_sentence.png](./assets/sina_3gram_sentence.png)
![sina_3gram_word.png](./assets/sina_3gram_word.png)

##### 维基百科

| 模型 | 字准确率  | 句准确率  | 训练时长  | 预测时长 |
| :--: | :-------: | :-------: | :-------: | :------: |
| 二元 | $78.36\%$ | $24.55\%$ | $148.81s$ | $3.24s$  |
| 三元 | $89.74\%$ | $56.09\%$ | $411.08s$ | $23.29s$ |

![wiki_3gram_sentence.png](./assets/wiki_3gram_sentence.png)
![wiki_3gram_word.png](./assets/wiki_3gram_word.png)
...
| 模型 | 字准确率  | 句准确率  | 训练时长  | 预测时长 |
| :--: | :-------: | :-------: | :-------: | :------: |
| 二元 | $81.81\%$ | $33.93\%$ | $159.55s$ | $3.28s$  |
| 三元 | $92.19\%$ | $64.27\%$ | $433.72s$ | $19.88s$ |

![baike_3gram_sentence.png](./assets/baike_3gram_sentence.png)
![baike_3gram_word.png](./assets/baike_3gram_word.png)
...
- **预测时长**：三元模型生成所有测试样例结果耗时约 17 秒，明显慢于二元模型（约 3 秒），但仍可以接受
...
**原因分析**：三元模型对一些三、四元词有了更好的补充，如“人际关系”、“第一次”、“体系概论”、“出门拍照”和“维基百科”等
